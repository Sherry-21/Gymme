...
export default function NewsDetail() {
    ...
    <ScrollView style={styles.baseColor}>
      <Image style={styles.aboveImage} source={require('@/assets/images/newsDetail/test-image.png')}></Image>
      <Pressable style={styles.backgroundArrow} onPress={backButton}>
        <Image style={styles.arrowBack} source={require('@/assets/images/newsDetail/arrow-back.png')}></Image>
      </Pressable>

      <View
        style={styles.mainLayout}>
          <View style={styles.textBookmark}>
            <Text style={styles.headerText}>Lorem ipsum dolor, sit amet consectetur adipisicing.</Text>
            <Pressable onPress={bookmarkNews}>
              {bookmark ? <Image style={styles.bookmarkImage} source={require('@/assets/images/newsDetail/bookmark.png')}></Image> : <Image style={styles.bookmarkImage} source={require('@/assets/images/newsDetail/bookmark-filled.png')}></Image>}
            </Pressable>
          </View>
